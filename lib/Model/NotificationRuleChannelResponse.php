...
/**
 * NotificationRuleChannelResponse Class Doc Comment
 *
 * @category Class
 * @package  emailguardSdk
 * @author   OpenAPI Generator team
 ...
 */
class NotificationRuleChannelResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NotificationRuleChannelResponse';
     ...
     * Sets channel_id
     *
     * @param string|null $channel_id Linked custom channel ID, if any.
     *
     * @return self
     */
     ...
     * Sets channel_name
     *
     * @param string|null $channel_name Name of the linked channel, when resolved.
     *
     * @return self
     */
     ...
     * Sets channel_type
     *
     * @param string|null $channel_type Type of the linked channel, when resolved.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Assignment record ID.
     *
     * @return self
     */
     ...
     * Sets predefined
     *
     * @param string|null $predefined Built-in channel identifier when not using a custom channel.
     *
     * @return self
     */
    public function setPredefined($predefined)
    {
        if (is_null($predefined)) {
            throw new \InvalidArgumentException('non-nullable predefined cannot be null');
        }
     ...
     * Sets target_user_id
     *
     * @param string|null $target_user_id User ID when delivery is scoped to one member.
     *
     * @return self
     */
