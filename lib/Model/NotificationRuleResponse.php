...
/**
 * NotificationRuleResponse Class Doc Comment
 *
 * @category Class
 * @package  emailguardSdk
 * @author   OpenAPI Generator team
 ...
 */
class NotificationRuleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NotificationRuleResponse';
    ...
    protected static $openAPITypes = [
        'channels' => '\emailguardSdk\Model\NotificationRuleChannelResponse[]',
     ...
     * Gets channels
     *
     * @return \emailguardSdk\Model\NotificationRuleChannelResponse[]|null
     */
     ...
     * Sets channels
     *
     * @param \emailguardSdk\Model\NotificationRuleChannelResponse[]|null $channels Channel targets notified when the rule matches.
     *
     * @return self
     */
     ...
     * Sets conditions
     *
     * @param array<string,mixed>|null $conditions Optional conditions (e.g. usage threshold percents).
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at When the rule was created (RFC3339).
     *
     * @return self
     */
     ...
     * Sets event_types
     *
     * @param string[]|null $event_types Event types that trigger this rule.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Rule record ID.
     *
     * @return self
     */
     ...
     * Sets is_enabled
     *
     * @param bool|null $is_enabled Whether the rule is actively delivering events.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Display name for the rule.
     *
     * @return self
     */
