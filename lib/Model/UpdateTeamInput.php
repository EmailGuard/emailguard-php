...
/**
 * UpdateTeamInput Class Doc Comment
 *
 * @category Class
 * @package  emailguardSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateTeamInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateTeamInput';
     ...
     * Sets email
     *
     * @param string|null $email Contact email address for the team workspace.
     *
     * @return self
     */
     ...
     * Sets emoji
     *
     * @param string|null $emoji Single grapheme emoji shown as the team avatar in the product UI.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Public website URL for the team.
     *
     * @return self
     */
