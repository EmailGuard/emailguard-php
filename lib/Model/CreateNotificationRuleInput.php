...
/**
 * CreateNotificationRuleInput Class Doc Comment
 *
 * @category Class
 * @package  emailguardSdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateNotificationRuleInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateNotificationRuleInput';
     ...
     * Gets channels
     *
     * @return \emailguardSdk\Model\NotificationRuleChannelInput[]
     */
     ...
     * Sets channels
     *
     * @param \emailguardSdk\Model\NotificationRuleChannelInput[] $channels One or more channel targets to notify when matching events occur.
     *
     * @return self
     */
     ...
     * Sets conditions
     *
     * @param array<string,mixed>|null $conditions Optional rule conditions (e.g. usage_threshold for USAGE_API_THRESHOLD).
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Optional longer description of what the rule does.
     *
     * @return self
     */
     ...
     * Sets event_types
     *
     * @param string[] $event_types Event type identifiers this rule listens for (at least one required).
     *
     * @return self
     */
    public function setEventTypes($event_types)
    {
        ...
        if ((count($event_types) < 1)) {
            throw new \InvalidArgumentException('invalid length for $event_types when calling CreateNotificationRuleInput., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets is_enabled
     *
     * @param bool|null $is_enabled When false, the rule is stored but does not deliver events.
     *
     * @return self
     */
