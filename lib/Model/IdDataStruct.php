...
/**
 * IdDataStruct Class Doc Comment
 *
 * @category Class
 * @package  emailguardSdk
 * @author   OpenAPI Generator team
 ...
 */
class IdDataStruct implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IdDataStruct';
     ...
     * Sets id
     *
     * @param string|null $id UUID of the created or referenced record.
     *
     * @return self
     */
