...
/**
 * NotificationRuleChannelInput Class Doc Comment
 *
 * @category Class
 * @package  emailguardSdk
 * @author   OpenAPI Generator team
 ...
 */
class NotificationRuleChannelInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NotificationRuleChannelInput';
     ...
     * Sets channel_id
     *
     * @param string|null $channel_id UUID of a team notification channel. Use this or predefined, not both.
     *
     * @return self
     */
     ...
     * Sets target_user_id
     *
     * @param string|null $target_user_id Restrict delivery to a specific team member's user ID.
     *
     * @return self
     */
